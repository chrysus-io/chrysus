...
var slackFileDynamic = function(outputDetails, results) {
    ...
    slack.uploadFile({
        file: fs.createReadStream(results), // In dynamic mode, "results" is the full path of a specific file
...
module.exports = slackFileDynamic;
