...
var slackContent = function(outputDetails, results) {
    logger.info("Sending results to Slack: " + results);
    logger.debug("slackContent outputDetails: " + (JSON.stringify(outputDetails)));
    ...
    slack.uploadFile({
        content: results, // This is the results of stdout from the child_process
